...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function dc(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:co(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function pc(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:co(),fragmentShader:`
	...
	`}function Ep(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===oa||c===ca,u=c===Pi||c===Li;if(l||u){let h=t.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return e===null&&(e=new hc(i)),h=l?e.fromEquirectangular(o,h):e.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return l&&p&&p.height>0||u&&p&&r(p)?(e===null&&(e=new hc(i)),h=l?e.fromEquirectangular(o):e.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function s(o){const c=o.target;c.removeEventListener("dispose",s);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function yp(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&Gn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Tp(i,t,e,n){const r={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete r[d.id];const p=s.get(d);p&&(t.remove(p),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(h,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,e.memory.geometries++),d}function c(h){const d=h.attributes;for(const p in d)t.update(d[p],i.ARRAY_BUFFER)}function l(h){const d=[],p=h.index,g=h.attributes.position;let v=0;if(p!==null){const A=p.array;v=p.version;for(let T=0,E=A.length;T<E;T+=3){const N=A[T+0],P=A[T+1],w=A[T+2];d.push(N,P,P,w,w,N)}}else if(g!==void 0){const A=g.array;v=g.version;for(let T=0,E=A.length/3-1;T<E;T+=3){const N=T+0,P=T+1,w=T+2;d.push(N,P,P,w,w,N)}}else return;const m=new($c(d)?Jc:jc)(d,1);m.version=v;const f=s.get(h);f&&t.remove(f),s.set(h,m)}function u(h){const d=s.get(h);if(d){const p=h.index;p!==null&&d.version<p.version&&l(h)}else l(h);return s.get(h)}return{get:o,update:c,getWireframeAttribute:u}}function Ap(i,t,e){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function c(d,p){i.drawElements(n,p,s,d*a),e.update(p,n,1)}function l(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,s,d*a,g),e.update(p,n,g))}function u(d,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];e.update(m,n,1)}function h(d,p,g,v){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)l(d[f]/a,p[f],v[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,d,0,v,0,g);let f=0;for(let A=0;A<g;A++)f+=p[A]*v[A];e.update(f,n,1)}}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function bp(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function wp(i,t,e){const n=new WeakMap,r=new Qt;function s(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let M=function(){U.dispose(),n.delete(o),o.removeEventListener("dispose",M)};var p=M;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],A=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let E=0;g===!0&&(E=1),v===!0&&(E=2),m===!0&&(E=3);let N=o.attributes.position.count*E,P=1;N>t.maxTextureSize&&(P=Math.ceil(N/t.maxTextureSize),N=t.maxTextureSize);const w=new Float32Array(N*P*4*h),U=new Zc(w,N,P,h);U.type=tn,U.needsUpdate=!0;const S=E*4;for(let C=0;C<h;C++){const k=f[C],z=A[C],W=T[C],Z=N*P*4*C;for(let G=0;G<k.count;G++){const j=G*S;g===!0&&(r.fromBufferAttribute(k,G),w[Z+j+0]=r.x,w[Z+j+1]=r.y,w[Z+j+2]=r.z,w[Z+j+3]=0),v===!0&&(r.fromBufferAttribute(z,G),w[Z+j+4]=r.x,w[Z+j+5]=r.y,w[Z+j+6]=r.z,w[Z+j+7]=0),m===!0&&(r.fromBufferAttribute(W,G),w[Z+j+8]=r.x,w[Z+j+9]=r.y,w[Z+j+10]=r.z,w[Z+j+11]=W.itemSize===4?r.w:1)}}d={count:h,texture:U,size:new Dt(N,P)},n.set(o,d),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const v=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",v),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function Rp(i,t,e,n){let r=new WeakMap;function s(c){const l=n.render.frame,u=c.geometry,h=t.get(c,u);if(r.get(h)!==l&&(t.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),r.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;r.get(d)!==l&&(d.update(),r.set(d,l))}return h}function a(){r=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:s,dispose:a}}const hl=new _e,mc=new sl(1,1),fl=new Zc,dl=new Hu,pl=new nl,gc=[],_c=[],xc=new Float32Array(16),vc=new Float32Array(9),Mc=new Float32Array(4);function Hi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=gc[r];if(s===void 0&&(s=new Float32Array(r),gc[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function fe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function de(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function us(i,t){let e=_c[t];e===void 0&&(e=new Int32Array(t),_c[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Cp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Pp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(fe(e,t))return;i.uniform2fv(this.addr,t),de(e,t)}}function Lp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(fe(e,t))return;i.uniform3fv(this.addr,t),de(e,t)}}function Dp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(fe(e,t))return;i.uniform4fv(this.addr,t),de(e,t)}}function Up(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(fe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),de(e,t)}else{if(fe(e,n))return;Mc.set(n),i.uniformMatrix2fv(this.addr,!1,Mc),de(e,n)}}function Ip(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(fe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),de(e,t)}else{if(fe(e,n))return;vc.set(n),i.uniformMatrix3fv(this.addr,!1,vc),de(e,n)}}function Np(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(fe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),de(e,t)}else{if(fe(e,n))return;xc.set(n),i.uniformMatrix4fv(this.addr,!1,xc),de(e,n)}}function Fp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Op(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(fe(e,t))return;i.uniform2iv(this.addr,t),de(e,t)}}function Bp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(fe(e,t))return;i.uniform3iv(this.addr,t),de(e,t)}}function zp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(fe(e,t))return;i.uniform4iv(this.addr,t),de(e,t)}}function kp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Hp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(fe(e,t))return;i.uniform2uiv(this.addr,t),de(e,t)}}function Vp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(fe(e,t))return;i.uniform3uiv(this.addr,t),de(e,t)}}function Gp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(fe(e,t))return;i.uniform4uiv(this.addr,t),de(e,t)}}function Wp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(mc.compareFunction=Yc,s=mc):s=hl,e.setTexture2D(t||s,r)}function Xp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||dl,r)}function qp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||pl,r)}function Yp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||fl,r)}function $p(i){switch(i){case 5126:return Cp;case 35664:return Pp;case 35665:return Lp;case 35666:return Dp;case 35674:return Up;case 35675:return Ip;case 35676:return Np;case 5124:case 35670:return Fp;case 35667:case 35671:return Op;case 35668:case 35672:return Bp;case 35669:case 35673:return zp;case 5125:return kp;case 36294:return Hp;case 36295:return Vp;case 36296:return Gp;case 35678:case 36198:case 36298:case 36306:case 35682:return Wp;case 35679:case 36299:case 36307:return Xp;case 35680:case 36300:case 36308:case 36293:return qp;case 36289:case 36303:case 36311:case 36292:return Yp}}function Zp(i,t){i.uniform1fv(this.addr,t)}function Kp(i,t){const e=Hi(t,this.size,2);i.uniform2fv(this.addr,e)}function jp(i,t){const e=Hi(t,this.size,3);i.uniform3fv(this.addr,e)}function Jp(i,t){const e=Hi(t,this.size,4);i.uniform4fv(this.addr,e)}function Qp(i,t){const e=Hi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function tm(i,t){const e=Hi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function em(i,t){const e=Hi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function nm(i,t){i.uniform1iv(this.addr,t)}function im(i,t){i.uniform2iv(this.addr,t)}function rm(i,t){i.uniform3iv(this.addr,t)}function sm(i,t){i.uniform4iv(this.addr,t)}function am(i,t){i.uniform1uiv(this.addr,t)}function om(i,t){i.uniform2uiv(this.addr,t)}function cm(i,t){i.uniform3uiv(this.addr,t)}function lm(i,t){i.uniform4uiv(this.addr,t)}function um(i,t,e){const n=this.cache,r=t.length,s=us(e,r);fe(n,s)||(i.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||hl,s[a])}function hm(i,t,e){const n=this.cache,r=t.length,s=us(e,r);fe(n,s)||(i.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||dl,s[a])}function fm(i,t,e){const n=this.cache,r=t.length,s=us(e,r);fe(n,s)||(i.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||pl,s[a])}function dm(i,t,e){const n=this.cache,r=t.length,s=us(e,r);fe(n,s)||(i.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||fl,s[a])}function pm(i){switch(i){case 5126:return Zp;case 35664:return Kp;case 35665:return jp;case 35666:return Jp;case 35674:return Qp;case 35675:return tm;case 35676:return em;case 5124:case 35670:return nm;case 35667:case 35671:return im;case 35668:case 35672:return rm;case 35669:case 35673:return sm;case 5125:return am;case 36294:return om;case 36295:return cm;case 36296:return lm;case 35678:case 36198:case 36298:case 36306:case 35682:return um;case 35679:case 36299:case 36307:return hm;case 35680:case 36300:case 36308:case 36293:return fm;case 36289:case 36303:case 36311:case 36292:return dm}}class mm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=$p(e.type)}}class gm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=pm(e.type)}}class _m{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const Zs=/(\w+)(\])?(\[|\.)?/g;function Sc(i,t){i.seq.push(t),i.map[t.id]=t}function xm(i,t,e){const n=i.name,r=n.length;for(Zs.lastIndex=0;;){const s=Zs.exec(n),a=Zs.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){Sc(e,l===void 0?new mm(o,i,t):new gm(o,i,t));break}else{let h=e.map[o];h===void 0&&(h=new _m(o),Sc(e,h)),e=h}}}class Zr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);xm(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],c=n[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function Ec(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const vm=37297;let Mm=0;function Sm(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const yc=new Ct;function Em(i){Gt._getMatrix(yc,Gt.workingColorSpace,i);const t=`mat3( ${yc.elements.map(e=>e.toFixed(4))} )`;switch(Gt.getTransfer(i)){case Jr:return[t,"LinearTransferOETF"];case Jt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Tc(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`
...
`)}function Rm(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function er(i){return i!==""}function Ac(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function bc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Cm=/^[ \t]*#include +<([\w\d./]+)>/gm;function ka(i){return i.replace(Cm,Lm)}const Pm=new Map;function Lm(i,t){let e=Lt[t];if(e===void 0){const n=Pm.get(t);if(n!==void 0)e=Lt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ka(e)}const Dm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function wc(i){return i.replace(Dm,Um)}function Um(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Rc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Im(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Nc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Pl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ln&&(t="SHADOWMAP_TYPE_VSM"),t}function Nm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Pi:case Li:t="ENVMAP_TYPE_CUBE";break;case os:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Fm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Li:t="ENVMAP_MODE_REFRACTION";break}return t}function Om(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Fc:t="ENVMAP_BLENDING_MULTIPLY";break;case Zl:t="ENVMAP_BLENDING_MIX";break;case Kl:t="ENVMAP_BLENDING_ADD";break}return t}function Bm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function zm(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Im(e),l=Nm(e),u=Fm(e),h=Om(e),d=Bm(e),p=bm(e),g=wm(s),v=r.createProgram();let m,f,A=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};const ke=new io,qt=new De(75,window.innerWidth/window.innerHeight,.01,1e3),He=new ml({antialias:!0});new Ln().load("/textures/ground.png");function dg(){He.setSize(window.innerWidth,window.innerHeight),He.sortObjects=!0,document.body.appendChild(He.domElement),qt.position.set(0,1.6,5),qt.lookAt(0,1.6,0),ke.fog=new no(16777215,10,50);const i=new Th(16777215,.5);ke.add(i);const t=new yh(16777215,.5);t.position.set(5,10,7.5),ke.add(t);const e=new Sh(16755251,1,10);e.position.set(2,3,0),ke.add(e);const n=new hs;n.scale.setScalar(45e4),ke.add(n);const r=new R,s={elevation:2,azimuth:180,exposure:He.toneMappingExposure};function a(){const c=bo.degToRad(90-s.elevation),l=bo.degToRad(s.azimuth);r.setFromSphericalCoords(1,c,l),n.material.uniforms.sunPosition.value.copy(r),He.toneMappingExposure=s.exposure,He.render(ke,qt)}a(),window.addEventListener("resize",pg,!1);function o(){requestAnimationFrame(o),He.render(ke,qt)}o()}function pg(){qt.aspect=window.innerWidth/window.innerHeight,qt.updateProjectionMatrix(),He.setSize(window.innerWidth,window.innerHeight)}let Vr=null,tr=null,Ha=!1;function mg(){if(Ha)return;Vr=new ll,qt.add(Vr),tr={jump:new Ba(Vr),slash:new Ba(Vr)};const i=new cl;i.load("./sfx/jump.wav",t=>{tr.jump.setBuffer(t),tr.jump.setVolume(.5),console.log("jump.wav loaded successfully")},void 0,t=>{console.error("Failed to load jump.wav:",t)}),i.load("./sfx/slash.wav",t=>{tr.slash.setBuffer(t),tr.slash.setVolume(.5),console.log("slash.wav loaded successfully")},void 0,t=>{console.error("Failed to load slash.wav:",t)}),Ha=!0}function gg(i,t,e,n,r,s,a,o){const u=new R;i.w&&(u.z-=1),i.s&&(u.z+=1),i.a&&(u.x-=1),i.d&&(u.x+=1),u.normalize().multiplyScalar(.08);const h=t.position.clone().add(u.applyQuaternion(e.quaternion));let d=!0,p=new R(0,0,0);r.forEach(g=>{const v=h.distanceTo(g.position);let m=.6;g.type==="tree1.png"||g.type==="tree3.png"?m=.5:g.type==="tree2.png"&&(m=.7);const f=t.radius+g.radius*m;if(v<f){d=!1;const A=new R().subVectors(h,g.position).normalize().multiplyScalar(.02);p.add(A)}}),s.forEach(g=>{const v=h.distanceTo(g.position),m=t.radius+g.radius;v<m&&(d=!1,console.log(`Collision with structure: Distance ${v.toFixed(2)} < ${m}, Player: (${h.x.toFixed(2)}, ${h.z.toFixed(2)}), Struct: (${g.position.x.toFixed(2)}, ${g.position.z.toFixed(2)})`))}),d?t.position.copy(h):p.length()>0&&t.position.add(p),t.velocityY+=-.008,t.position.y+=t.velocityY,t.position.y<1.6&&(t.position.y=1.6,t.velocityY=0),e.rotation.order="YXZ",e.rotation.y=-a,e.rotation.x=-o}const un={w:!1,a:!1,s:!1,d:!1,e:!1," ":!1},cr={position:qt.position,radius:1,velocityY:0};let gl=0,Kr=0,Dc=0;const _g=.3,jt={hand:{mesh:new ie(new We(.5,.5),new xe({map:new Ln().load("./textures/hand.png"),transparent:!0,side:Re})),position:{x:.3,y:-.3,z:-.5}},sword:{mesh:new ie(new We(.5,1),new xe({map:new Ln().load("./textures/sword.png"),transparent:!0,side:Re})),position:{x:.3,y:-.2,z:-.5},swing:{active:!1,time:0,speed:.05}}};jt.sword.mesh.visible=!1;let fn=!1;function xg(i){Object.values(jt).forEach(t=>{qt.add(t.mesh),t.mesh.position.set(t.position.x,t.position.y,t.position.z)}),i.add(qt),document.body.requestPointerLock=document.body.requestPointerLock||document.body.mozRequestPointerLock,document.addEventListener("click",()=>{Ha||mg(),document.body.requestPointerLock(),fn&&!jt.sword.swing.active&&(jt.sword.swing.active=!0,jt.sword.swing.time=0,sfx&&sfx.slash.buffer?(sfx.slash.stop(),sfx.slash.play(),console.log("Attempting to play slash.wav")):console.warn("slash.wav not loaded yet or sfx not initialized"))}),document.addEventListener("mousemove",t=>{document.pointerLockElement===document.body&&(gl+=t.movementX*.002,Kr+=t.movementY*.002,Kr=Math.max(-Math.PI/2,Math.min(Math.PI/2,Kr)))}),document.addEventListener("keydown",t=>{t.key in un&&(un[t.key]=!0),t.key==="e"&&Mg(),t.key===" "&&cr.position.y<=1.6&&(cr.velocityY=_g,sfx&&sfx.jump.buffer?(sfx.jump.stop(),sfx.jump.play(),console.log("Attempting to play jump.wav")):console.warn("jump.wav not loaded yet or sfx not initialized"))}),document.addEventListener("keyup",t=>{t.key in un&&(un[t.key]=!1)})}function vg(i,t,e){gg(un,cr,qt,i,t,e,gl,Kr),Dc+=.05;const n=fn?jt.sword:jt.hand,r=new R;if(un.w||un.s||un.a||un.d?(n.mesh.position.y=(fn?jt.sword.position.y:jt.hand.position.y)+Math.sin(Dc*2)*.05,n.mesh.rotation.z=-r.x*.1):(n.mesh.position.y=fn?jt.sword.position.y:jt.hand.position.y,n.mesh.rotation.z=0),jt.sword.swing.active){jt.sword.swing.time+=jt.sword.swing.speed;const s=jt.sword.swing.time;s<1?(jt.sword.mesh.position.y=jt.sword.position.y+Math.sin(s*Math.PI)*.5,jt.sword.mesh.position.x=jt.sword.position.x-Math.sin(s*Math.PI/2)*.5):(jt.sword.swing.active=!1,jt.sword.mesh.position.set(jt.sword.position.x,jt.sword.position.y,jt.sword.position.z))}if(fn&&jt.sword.swing.active){const s=jt.sword.swing.time;s>.3&&s<.7&&(window.enemies||[]).forEach(o=>{cr.position.distanceTo(o.position)<3&&o.takeDamage(25)})}}function Mg(){fn=!fn,jt.hand.mesh.visible=!fn,jt.sword.mesh.visible=fn}function fs(i){return new Ln().load(i)}function _l(i,t,e){const n=new ie(i,t);return n.position.set(e.x,e.y,e.z),n}function xl(i,t,e,n){const r=fs(i),s=new We(t,e);s.translate(0,e/2,0);const a=new xe({map:r,transparent:!0,alphaTest:.5,side:Re});return _l(s,a,n)}const Fi=[],lo=[],rs=[],ss=[];function Sg(i){const t=fs("./textures/ground.png");t.wrapS=t.wrapT=jr,t.repeat.set(20,20);const e=new xe({map:t}),n=new We(200,200),r=_l(n,e,{x:0,y:0,z:0});r.rotation.x=-Math.PI/2,i.add(r),Eg(i),Ag(i)}function Eg(i){const t=["tree1.png","tree2.png","tree3.png"],n=[];for(let a=0;a<15;a++){const o=(Math.random()-.5)*180,c=(Math.random()-.5)*180;n.push({x:o,z:c,radius:10+Math.random()*15})}const s=120;for(let a=0;a<s;a++){let o,c;if(Math.random()<.8){const g=n[Math.floor(Math.random()*n.length)],v=Math.random()*Math.PI*2,m=Math.pow(Math.random(),2)*g.radius;o=g.x+Math.cos(v)*m,c=g.z+Math.sin(v)*m}else o=(Math.random()-.5)*190,c=(Math.random()-.5)*190;if(Fi.some(g=>Math.hypot(o-g.position.x,c-g.position.z)<2)){a--;continue}const u=t[Math.floor(Math.random()*3)];let h,d;u==="tree1.png"?(h=5,d=8):u==="tree2.png"?(h=2.5,d=2.5):u==="tree3.png"&&(h=5,d=9);const p=xl(`./textures/${u}`,h,d,{x:o,y:0,z:c});i.add(p),Fi.push({mesh:p,position:new R(o,0,c),radius:2,type:u})}yg(i,n)}function yg(i,t){Tg(i,250,t);const n=100;for(let r=0;r<n;r++){let s,a;if(Math.random()<.6){const u=t[Math.floor(Math.random()*t.length)],h=Math.random()*Math.PI*2,d=(.7+Math.random()*.5)*u.radius;s=u.x+Math.cos(h)*d,a=u.z+Math.sin(h)*d}else s=(Math.random()-.5)*190,a=(Math.random()-.5)*190;const c=Math.floor(Math.random()*3)+1,l=xl(`./textures/flower${c}.png`,.8,.8,{x:s,y:.25,z:a});i.add(l),lo.push({mesh:l})}}function Tg(i,t,e){const n=new We(.875,.875);n.translate(0,.875/2,0);for(let r=1;r<=3;r++){const s=fs(`./textures/grass${r}.png`),a=new xe({map:s,transparent:!0,alphaTest:.5,side:Re}),o=Math.floor(t/3),c=new ch(n,a,o),l=new Wt;let u=0;for(let h=0;h<o;h++){let d,p;if(Math.random()<.7){const m=e[Math.floor(Math.random()*e.length)],f=Math.random()*Math.PI*2,A=Math.random()*(m.radius+5);d=m.x+Math.cos(f)*A,p=m.z+Math.sin(f)*A}else d=(Math.random()-.5)*190,p=(Math.random()-.5)*190;const v=.8+Math.random()*.4;l.makeRotationY(Math.random()*Math.PI*2),l.setPosition(d,0,p),l.scale(new R(v,v,v)),c.setMatrixAt(u++,l)}i.add(c),c.userData={isInstanced:!0},rs.push({mesh:c,isInstanced:!0})}}function Ag(i){function t(s){const a=fs("./textures/rock_wall.png"),o=new xe({map:a}),c=new Ei,l=new Pn(10,5,10),u=new ie(l,o);u.position.y=2.5,c.add(u);const h=new cs(7,3,4),d=new xe({color:16711680}),p=new ie(h,d);return p.position.y=5,c.add(p),s.add(c),{mesh:c,position:new R,radius:5}}function e(s){const a=new Ei,o=new Pn(1,2,.5),c=new xe({color:8421504});for(let l=0;l<5;l++){const u=new ie(o,c);u.position.set((l-2)*2,1,0),a.add(u)}return s.add(a),{mesh:a,position:new R,radius:3}}const n=[t,e],r=20;for(let s=0;s<5;s++){let a=!1,o;for(;!a;)o=(Math.random()-.5)*190,a=ss.every(u=>Math.abs(o-u.position.z)>r);const c=95,l=n[Math.floor(Math.random()*2)](i);l.mesh.position.set(c,0,o),l.position.set(c,0,o),ss.push(l)}}function bg(i){function t(n){if(!n||!n.mesh)return;const r=n.mesh.rotation.y,s=Math.atan2(i.position.x-n.mesh.position.x,i.position.z-n.mesh.position.z),o=r+(s-r)*.1;n.mesh.rotation.y=o,n.mesh.rotation.x=0,n.mesh.rotation.z=0}function e(n){if(!n.isInstanced||!n.mesh)return;const r=n.mesh,s=r.count,a=new Wt,o=new R;o.copy(i.position),o.y=0;for(let c=0;c<s;c++){r.getMatrixAt(c,a);const l=new R;l.setFromMatrixPosition(a);const u=new R;u.subVectors(i.position,l),u.y=0,u.normalize();const h=Math.atan2(u.x,u.z),d=new Wt;d.makeRotationY(h),d.setPosition(l.x,l.y,l.z);const p=a.getMaxScaleOnAxis();d.scale(new R(p,p,p)),r.setMatrixAt(c,d)}r.instanceMatrix.needsUpdate=!0}Fi.forEach(t),lo.forEach(t),rs.filter(n=>!n.isInstanced).forEach(t),rs.filter(n=>n.isInstanced).forEach(e)}function wg(i){const t=new Ln;return i.map(e=>t.load(e))}function Rg(i,t,e){const n=Date.now();if(n-i.lastUpdate>e){if(i.frame=(i.frame+1)%t.length,!i.mesh||!i.mesh.material){console.error("Animation mesh or material is undefined",i);return}i.mesh.material.map=t[i.frame],i.mesh.material.needsUpdate=!0,i.lastUpdate=n}}const Rn=[],Cg={walking:{front:["skeleton_walk_front_1.png","skeleton_walk_front_2.png","skeleton_walk_front_3.png"],back:["skeleton_walk_back_1.png","skeleton_walk_back_2.png","skeleton_walk_back_3.png"],left:["skeleton_walk_left_1.png","skeleton_walk_left_2.png","skeleton_walk_left_3.png"],right:["skeleton_walk_right_1.png","skeleton_walk_right_2.png","skeleton_walk_right_3.png"]},attack:{front:["skeleton_attack_front_1.png","skeleton_attack_front_2.png","skeleton_attack_front_3.png"],back:["skeleton_attack_back_1.png","skeleton_attack_back_2.png","skeleton_attack_back_3.png"],left:["skeleton_attack_left_1.png","skeleton_attack_left_2.png","skeleton_attack_left_3.png"],right:["skeleton_attack_right_1.png","skeleton_attack_right_2.png","skeleton_attack_right_3.png"]}},Pg=200,as={};Object.entries(Cg).forEach(([i,t])=>{as[i]={},Object.entries(t).forEach(([e,n])=>{as[i][e]=wg(n.map(r=>`/textures/enemies/${r}`))})});function Lg(i,t){const e=new ie(new We(2,3),new xe({map:as.walking.front[0],transparent:!0,side:Re}));e.position.set(t.x,1.5,t.z),i.add(e);const n={mesh:e,position:new R(t.x,0,t.z),radius:1,direction:new R(0,0,0),speed:.03,state:"idle",animation:{action:"walking",direction:"front",frame:0,timer:0,lastUpdate:Date.now(),mesh:e},health:100,attackRange:2,attackCooldown:0,update:function(r,s,a){switch(this.state){case"idle":Math.random()<.01&&(this.state="wandering",this.chooseRandomDirection());break;case"wandering":this.position.distanceTo(s)<10&&(this.state="chasing"),Math.random()<.005&&this.chooseRandomDirection(),this.move(a);break;case"chasing":const o=new R().subVectors(s,this.position).normalize();this.direction.copy(o),this.position.distanceTo(s)<this.attackRange?(this.state="attacking",this.animation.action="attack",this.animation.frame=0):this.move(a);break;case"attacking":this.attackCooldown>0?this.attackCooldown-=r:this.position.distanceTo(s)<this.attackRange?(window.sfx&&window.sfx.enemy_hit&&window.sfx.enemy_hit.play(),this.attackCooldown=1e3):(this.state="chasing",this.animation.action="walking");break}Rg(this.animation,as[this.animation.action][this.animation.direction],Pg),this.mesh.position.set(this.position.x,1.5,this.position.z),this.updateAnimationDirection(s)},move:function(r){const s=this.position.clone().addScaledVector(this.direction,this.speed);let a=!0;r.forEach(o=>{const c=s.distanceTo(o.position),l=this.radius+o.radius;c<l&&(a=!1,this.chooseRandomDirection())}),a&&this.position.copy(s)},updateAnimationDirection:function(r){if(this.state==="chasing"||this.state==="attacking"){const s=new R().subVectors(r,this.position),a=Math.atan2(s.x,s.z);a>-Math.PI/4&&a<Math.PI/4?this.animation.direction="front":a>=Math.PI/4&&a<3*Math.PI/4?this.animation.direction="right":a<=-Math.PI/4&&a>-3*Math.PI/4?this.animation.direction="left":this.animation.direction="back"}else this.state==="wandering"&&(Math.abs(this.direction.z)>Math.abs(this.direction.x)?this.animation.direction=this.direction.z>0?"front":"back":this.animation.direction=this.direction.x>0?"right":"left")},chooseRandomDirection:function(){const r=Math.random()*Math.PI*2;this.direction.set(Math.sin(r),0,Math.cos(r)).normalize()},takeDamage:function(r){this.health-=r,window.sfx&&window.sfx.enemy_hit&&window.sfx.enemy_hit.play(),this.health<=0&&this.die()},die:function(){window.sfx&&window.sfx.enemy_dies&&window.sfx.enemy_dies.play(),i.remove(this.mesh);const r=Rn.findIndex(s=>s===this);r!==-1&&Rn.splice(r,1)}};return Rn.push(n),n}function Dg(i,t,e){Rn.forEach(n=>{n.update(i,t,e)})}function Ug(i){Rn.forEach(t=>{if(!t||!t.mesh)return;const e=new R;e.subVectors(i.position,t.mesh.position),e.y=0,e.normalize();const n=Math.atan2(e.x,e.z);t.mesh.rotation.y=n,t.mesh.rotation.x=0,t.mesh.rotation.z=0})}let Ks,Va,Ti;function Ig(i,t){const e=new io,n=new ls(-window.innerWidth/2,window.innerWidth/2,window.innerHeight/2,-window.innerHeight/2,.1,1e3);n.position.z=10;const r=new Ln().load("./textures/ui/crosshair.png"),s=32,a=new Oa({map:r,transparent:!0,depthTest:!1});Ks=new qo(a),Ks.scale.set(s,s,1),e.add(Ks);const o=document.createElement("canvas"),c=o.getContext("2d");o.width=256,o.height=64,c.fillStyle="rgba(0, 0, 0, 0)",c.fillRect(0,0,o.width,o.height),c.font="24px Arial",c.fillStyle="white",c.textAlign="center",c.fillText("",o.width/2,o.height/2);const l=new fh(o),u=new Oa({map:l,transparent:!0,depthTest:!1});return Ti=new qo(u),Ti.scale.set(o.width,o.height,1),Ti.position.y=-100,e.add(Ti),Va=new Rh,{uiScene:e,uiCamera:n,updateInteractionText:qn}}function qn(i){const t=Ti.material.map.image,e=t.getContext("2d");if(e.clearRect(0,0,t.width,t.height),i){e.fillStyle="rgba(0, 0, 0, 0.3)";const n=e.measureText(i).width+20;e.fillRect(t.width/2-n/2,t.height/2-15,n,30)}e.font="20px Arial",e.fillStyle="white",e.textAlign="center",e.fillText(i,t.width/2,t.height/2),Ti.material.map.needsUpdate=!0}function Ng(i,t){Va.setFromCamera(new Dt(0,0),i);const e=Va.intersectObjects(t.map(n=>n.mesh));if(e.length>0){const n=e[0].object,r=t.find(s=>s.mesh===n);r.type==="chest"?qn("Press E to open chest"):r.type==="door"?qn("Press E to open door"):r.type==="enemy"?qn("Left click to attack"):r.type==="npc"?qn("Press E to talk"):qn("Press E to interact")}else qn("")}let vl=null;function Fg(i){vl=i}function Og(i=!1){const t=new Ba(vl);return i&&t.setLoop(!0),t}function js(i,t=!1){const e={};return i.forEach(n=>{e[n]=Og(t)}),e}function Bg(i,t,e){new cl().load(i,r=>{t.setBuffer(r),t.setVolume(e),console.log(`Successfully loaded: ${i}`)},null,r=>{console.error(`Error loading ${i}:`,r)})}function zg(i,t){Object.entries(i).forEach(([e,n])=>{Bg(e,n,t)})}let Tn={},Gr={},me={},Ga=!1;function kg(i){if(Ga)return;const t=new ll;return i.add(t),Fg(t),Tn=js(["jump","slash","enemy_hit","enemy_dies","player_hit"]),Gr=js(["forest"],!0),me=js(["forest"],!0),zg({"/sfx/jump.wav":Tn.jump,"/sfx/slash.wav":Tn.slash,"/sfx/enemy_hit.wav":Tn.enemy_hit,"/sfx/enemy_dies.wav":Tn.enemy_dies,"/sfx/player_hit.wav":Tn.player_hit,"/music/forest.mp3":Gr.forest,"/music/forest.mp3":me.forest},.5),window.sfx=Tn,window.music=Gr,window.regionAudio=me,Ga=!0,{sfx:Tn,music:Gr,regionAudio:me}}function Hg(){return Ga}function Vg(i,t,e,n,r,s){t.position.x=i.position.x,t.position.z=i.position.z,e.position.x=i.position.x,e.position.z=i.position.z,e.rotation.z=-i.rotation.y,n.position.x=i.position.x,n.position.z=i.position.z,r.render(s,n)}function Gg(i,t){t.rotation.z=i.rotation.y}function Wg(i,t){t.forEach(e=>{const n=new ie(new ur(.5,32),new xe({color:16711680}));n.position.set(e.x,.1,e.z),i.add(n)})}let nr=!1;const Qn=new ie(new We(2,1),new xe({color:16777215,transparent:!0,opacity:.8}));Qn.position.set(0,0,-2);Qn.renderOrder=999;Qn.visible=!1;qt.add(Qn);const Xg=new Ln;Xg.load("./textures/pause.png",i=>{Qn.material.map=i,Qn.material.needsUpdate=!0});const Ai=150,Uc=30,ds=new ls(-30,Uc,Uc*(Ai/Ai),-30*(Ai/Ai),1,1e3);ds.position.set(0,50,0);ds.lookAt(0,0,0);ds.up.set(0,0,-1);const ei=new io;ei.background=new Nt(402693);const Dn=new ml({alpha:!0});Dn.setSize(Ai,Ai);Dn.domElement.style.position="absolute";Dn.domElement.style.top="10px";Dn.domElement.style.right="10px";Dn.domElement.style.border="2px solid #444";Dn.domElement.style.borderRadius="5px";document.body.appendChild(Dn.domElement);const ps=new ie(new ur(.5,8),new xe({color:16776960}));ps.position.y=.5;ps.rotation.x=-Math.PI/2;ei.add(ps);const ms=new ie(new cs(.3,1,3),new xe({color:16776960}));ms.position.y=.5;ms.rotation.x=-Math.PI/2;ei.add(ms);const qg=[{x:95,z:-50,type:"house",color:13789470},{x:95,z:20,type:"cemetery",color:8421504}];qg.forEach(i=>{const t=new ie(new ur(1,6),new xe({color:i.color}));t.position.set(i.x,.5,i.z),t.rotation.x=-Math.PI/2,ei.add(t)});const Yg=new Ch(200,20,2250018,1127185);ei.add(Yg);const $g=new rl(new Ie().setFromPoints([new R(-95,0,-95),new R(95,0,-95),new R(95,0,95),new R(-95,0,95),new R(-95,0,-95)]),new so({color:4521796}));ei.add($g);const Zg=new Ln().load("./textures/compass.png"),uo=new ie(new We(2,2),new xe({map:Zg,transparent:!0}));uo.position.set(0,2,-5);qt.add(uo);const Ml=[];function Kg(){nr=!nr,Qn.visible=nr,document.exitPointerLock(),!(!me||!me.forest)&&(nr?me.forest.isPlaying&&(me.forest.pause(),console.log("Music paused")):qt.position.x>=-95&&qt.position.x<=95&&qt.position.z>=-95&&qt.position.z<=95&&me.forest.buffer&&!me.forest.isPlaying&&(me.forest.play(),console.log("Music resumed on unpause in forest")))}document.addEventListener("keydown",i=>{i.key==="p"&&Kg(),i.key==="m"&&Ml.push({x:qt.position.x,z:qt.position.z,type:"point"})});dg();xg(ke);Sg(ke);const{uiScene:jg,uiCamera:Jg}=Ig(),Qg=[{x:10,z:10},{x:-15,z:20},{x:5,z:-25}];Qg.forEach(i=>{Lg(ke,i)});document.addEventListener("click",()=>{Hg()||kg(qt)});let Ic=performance.now();const t_=[];function e_(){function t(e){if(!e||!e.mesh)return;const n=e.mesh.position.distanceTo(qt.position);e.mesh.visible=n<50}Fi.forEach(t),lo.forEach(t),rs.filter(e=>!e.isInstanced).forEach(t),typeof Rn<"u"&&Rn.length&&Rn.forEach(t)}function Sl(){requestAnimationFrame(Sl);const i=performance.now(),t=i-Ic;Ic=i,nr||(vg(t,Fi,ss),Dg(t,cr.position,[...Fi,...ss]),bg(qt),Ug(qt),me&&me.forest&&(qt.position.x>=-95&&qt.position.x<=95&&qt.position.z>=-95&&qt.position.z<=95?!me.forest.isPlaying&&me.forest.buffer&&me.forest.play():me.forest.isPlaying&&me.forest.stop()),Vg(qt,ps,ms,ds,Dn,ei),Gg(qt,uo),Wg(ke,Ml),Ng(qt,[...t_]),e_()),He.render(ke,qt),He.autoClear=!1,He.render(jg,Jg),He.autoClear=!0}Sl();
